...
We cannot use vectorization here because it cannot perform comparisons and return specific values based on our criteria without using a function.
...
Yes, I create functions for extracting image, ingredients, and instructions from the website. I create a list that contain the html of each recipe, and I applied their index in the list to the function, so that the function can extract image, ingredients or instructions of a specific recipe.
